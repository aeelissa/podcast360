...
import { Settings, Users, Book, Key, ChevronDown, ChevronRight, ChevronLeft, Menu } from 'lucide-react';
    ...
    <>
      <div className={`podcast-panel h-full flex flex-col transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between mb-3 arabic-content">
            <div className="flex items-center gap-2">
              <button
                ...
                title={isMinimized ? "توسيع اللوحة" : "تصغير اللوحة"}
              >
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {activeView === 'settings' && !isMinimized && (
